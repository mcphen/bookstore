<template>
    <div class="col-sm">
        <a @click="openModal" class="btn btn-primary text-white"><i class="icon ion-ios-add"></i> Ajouter une catégorie</a>
        <br> <br>
    ...
    export default {
        ...
        methods: {
            ...
            edit_role(role){
                ...
                this.form.reset();
                $('#modalAddRole').modal('show');
                this.form.intitule=role.cat;
                this.form.description = role.description;
                this.form.publish = role.publish;
                this.form.most_popular = role.popular_cat;
                this.form.photo = role.image_cat;
                this.idRoleEdit = role.id;
            },

            add_role () {
                //console.log(this.form.publish); return false;
                Swal.fire({
                    title: "Checking...",
                    text: "Veuillez patienter!",
                    imageUrl: "/assets/img/6.gif",
            ...
            delete_role(id){
                ...
                Swal.fire({
                    ...
                    if(result.value==true){
                        axios.get('/destroy_categorie/'+id).then(resp =>{
